...
export async function createInvoice(formData: FormData) {
  ...
  // It's usually good practice to store monetary values in cents in your database to eliminate JavaScript floating-point errors and ensure greater accuracy. Convert the amount into cents
